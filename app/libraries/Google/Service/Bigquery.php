...
class Google_Service_Bigquery_Jobs_Resource extends Google_Service_Resource
{
  ...
  /**
   * Returns information about a specific job. Item information is available for a
   ...
   * @param string $jobId Item ID of the requested job
   * @param array $optParams Optional parameters.
   ...
   * @param string $jobId Item ID of the query job
   * @param array $optParams Optional parameters.
   *
