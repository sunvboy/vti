...
class Catalogue extends MY_Controller {
	...
	public function View($page = 1){
		$this->commonbie->permission("contact/backend/catalogue/view", $this->auth['permission']);
	...
	public function Create(){
		$this->commonbie->permission("contact/backend/catalogue/create", $this->auth['permission']);
	...
	public function Update($id = 0){
		$this->commonbie->permission("contact/backend/catalogue/update", $this->auth['permission']);
