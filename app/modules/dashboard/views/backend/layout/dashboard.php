...
<head>
	...
	<?php if(isset($isMultiDatesPicker) && $isMultiDatesPicker == TRUE ){ ?>
		<link href="plugin/multidatepicker/jquery-ui.multidatespicker.css" rel="stylesheet"/>
	<?php } ?>
...
<body>
	...
	<script>
		$(document).on('change','.publish_frontend',function(){
			let _this = $(this);
			let objectid = _this.attr('data-id');
			let module = _this.attr('data-module');
			let title = _this.attr('data-title');
			let formURL = 'dashboard/home/publish_frontend';
			$.post(formURL, {objectid: objectid,module:module,title:title},
				function(data){
