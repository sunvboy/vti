<div class="col-md-3 col-sm-4 col-xs-12">
    ...
    $ct_isfooter = $this->Autoload_Model->_get_where(array(
        ...
        'where' => array('parentid' => 5, 'publish' => 0, 'alanguage' => $this->fc_lang)), TRUE);
    ?>
    <?php if (isset($ct_isfooter) && is_array($ct_isfooter) && count($ct_isfooter)) { ?>
        <aside class="aside_menu">
            <ul>
                <?php foreach ($ct_isfooter as $k => $v) {
