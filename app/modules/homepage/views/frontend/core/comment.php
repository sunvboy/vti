...
<div class="block-comments">
	...
	<div class="ibox-content" style="position:relative;padding-right:10px;padding-left:10px;">
		<div class="block-comment">
			<?php
			$listComment = comment_render(array('module'=>'product','detailid'=>$productDetail['id']));?>
			...
			<ul class="list-comment uk-list uk-clearfix">
							...
							<div class="comment">
								...
								<div class="cmt-content">
									...
									<div class="uk-flex uk-flex-middle _cmt-reply">
										...
										<a href="javascript:void(0)" class="btn-reply" data-id="<?php echo $val['id'];?>" data-comment="1">Trả lời</a>
									</div>
				...
				<div class="loadmore-cmt"><a href="" title="" class="btn-loadmore" data-module="<?php echo $module;?>" data-detailid="" data-start="1" data-limit="2" data-total="">Xem thêm</a></div>
			<?php }else{?>
...
$(document).ready(function(){
	...
	$(document).on('click','.btn-reply', function(e){
		...
		let param = {
			...
			'module' : 'product',
			'detailid' : <?php echo $productDetail['id']?>,
		};
