								...
								<div class="toolbox">
									...
									<div class="uk-flex uk-flex-middle uk-flex-space-between">
										...
										<div class="uk-button">
											...
											<a href="<?php echo site_url('job/backend/catalogue/create'); ?>" class="btn btn-danger hidden"><i class="fa fa-plus"></i> Thêm danh mục bài viết mới</a>
							...
							<table class="table table-striped table-bordered table-hover dataTables-example" id="ajax-content" >
								...
								<thead>
									...
									<tr>
										...
										<th class="hidden" style="width:40px;">
