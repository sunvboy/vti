                            ...
                            <div class="ibox-title" style="padding: 9px 15px 0px;">
                                <div class="uk-flex uk-flex-middle uk-flex-space-between">
                                    ...
                                    <div class="ibox-tools">
                                        <button type="submit" name="create" value="create" class="btn btn-success  full-width ">Tạo mới
                                        </button>
                                    </div>
                            ...
                            <div class="ibox mb20">
                                ...
                                <div class="ibox-content">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="google">
                                                <div class="g-title"><?php echo ($this->input->post('meta_title')) ? $this->input->post('meta_title') : (($this->input->post('title')) ? $this->input->post('title') : 'OVN - Đơn vị thiết kế website hàng đầu Việt Nam'); ?></div>
                        ...
                        <div id="home1" class="tab-pane fade">
                            ...
                            <div class="ibox mb20">
                                <div class="form-row">
                                    ...
                                    <?php echo form_textarea('gioithieuvechuongtrinh', htmlspecialchars_decode(html_entity_decode(set_value('gioithieuvechuongtrinh'))), 'class="form-control ck-editor" id="ckDescription2" placeholder="" autocomplete="off"');?>
                                </div>
                            </div>
                            <div class="ibox mb20">
                               <div class="row">
                                   <div class="col-md-6">
                                       ...
                                       <div class="ibox-content">
                                           <div class="form-row">
                                               <div class="avatar local_result" style="cursor: pointer;"><img src="<?php echo ($this->input->post('khungchuongtrinh')) ? $this->input->post('khungchuongtrinh') : 'template/not-found.png' ?>" class="img-thumbnail" alt=""></div>
                                               <?php echo form_input('khungchuongtrinh', htmlspecialchars_decode(html_entity_decode(set_value('khungchuongtrinh'))), 'class="form-control " placeholder="Đường dẫn của ảnh" onclick="openKCFinder(this)"  autocomplete="off"');?>
                                           </div>
                                       </div>
                                   ...
                                   <div class="col-md-6">
                                       ...
                                       <div class="ibox-content">
                                           <div class="form-row">
                                               <div class="avatar local_result" style="cursor: pointer;"><img src="<?php echo ($this->input->post('khungchuongtrinh_b')) ? $this->input->post('khungchuongtrinh_b') : 'template/not-found.png' ?>" class="img-thumbnail" alt=""></div>
                                               <?php echo form_input('khungchuongtrinh_b', htmlspecialchars_decode(html_entity_decode(set_value('khungchuongtrinh_b'))), 'class="form-control " placeholder="Đường dẫn của ảnh" onclick="openKCFinder(this)"  autocomplete="off"');?>
                                           </div>
                                       </div>
                            ...
                            <div class="ibox mb20">
                                <div class="form-group row" id="fromSlide">
                                    ...
                                    if (isset($albumC) && is_array($albumC) && count($albumC)) { ?>
                                        <?php foreach ($albumC['description'] as $key => $val) {
                                            if (empty($albumC['description'][$key])) continue; ?>
                        ...
                        <div id="home4" class="tab-pane fade">
                            ...
                            <div class="row mb15">
                                <div class="col-lg-12">
                                    <div class="form-row">
                                        ...
                                        <?php echo form_input('facebook', htmlspecialchars_decode(html_entity_decode(set_value('facebook'))), 'class="form-control " placeholder="" autocomplete="off"');?>
                                    </div>
                                </div>
                            </div>
                            <div class="row mb15">
                                <div class="col-lg-12">
                                    <div class="form-row">
                                        ...
                                        <?php echo form_input('twitter', htmlspecialchars_decode(html_entity_decode(set_value('twitter'))), 'class="form-control " placeholder="" autocomplete="off"');?>
                                    </div>
                                </div>
                            </div>
                            <div class="row mb15">
                                <div class="col-lg-12">
                                    <div class="form-row">
                                        ...
                                        <?php echo form_input('instagram', htmlspecialchars_decode(html_entity_decode(set_value('instagram'))), 'class="form-control " placeholder="" autocomplete="off"');?>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="ibox mb20">
                                <div class="form-group row" id="fromSlide2">
                                    <?php $albumC_2 = $this->input->post('albumC_2');
                                    if (isset($albumC_2) && is_array($albumC_2) && count($albumC_2)) { ?>
                                        <?php foreach ($albumC_2['description'] as $key => $val) {
                                            if (empty($albumC_2['description'][$key])) continue; ?>
                                            <div class="col-sm-4 slideItem" style="height: auto;">
                                                <textarea name="albumC_2[description][]" cols="40" rows="10"  class="form-control "  placeholder="Nội dung"><?php echo $albumC_2['description'][$key]; ?></textarea>
