        ...
        <div class="wrapper wrapper-content animated fadeInRight">
            ...
            <div class="row">
                <div class="col-lg-8 clearfix">
                                ...
                                <div class="uk-flex uk-flex-middle uk-flex-space-between">
                                    ...
                                    <div class="ibox-tools " style="display: flex;">
                                        <button type="submit" name="update" value="update"
                                                class="btn btn-success block full-width m-b">Lưu
                                        </button>
                                        <a target="_blank" href="<?php echo $detailjob['canonical'] ?>.html"
                                           class="btn btn-primary block m-b pull-right hidden"
                                           style="margin-right:10px;">Xem
                                            trước</a>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="row mb15">
                                        <div class="col-lg-12">
                                            <div class="form-row">
                                                ...
                                                <?php echo form_textarea('content', htmlspecialchars_decode(html_entity_decode(set_value('content', $detailjob['content']))), 'class="form-control ck-editor" id="ckContent" placeholder="" autocomplete="off"'); ?>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mb15">
                                                ...
                                                <div class="form-row">
                                                    <div class="uk-flex uk-flex-middle uk-flex-space-between">
                                                        ...
                                                        <span style="color:#9fafba;"><span
                                                                    id="titleCount"><?php echo strlen($detailjob['meta_title']) ?></span> trên 70 ký tự</span>
                                                    </div>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="form-row">
                                                    <div class="uk-flex uk-flex-middle uk-flex-space-between">
                                                        ...
                                                        <span style="color:#9fafba;"><span
                                                                    id="descriptionCount"><?php echo strlen($detailjob['meta_description']) ?></span> trên 320 ký tự</span>
                                                    </div>
                        ...
                        <div id="home1" class="tab-pane fade">
                            ...
                            <div class="ibox mb20">
                                <div class="form-row">
                                    ...
                                    <?php echo form_textarea('gioithieuvechuongtrinh', htmlspecialchars_decode(html_entity_decode(set_value('gioithieuvechuongtrinh', $detailjob['gioithieuvechuongtrinh']))), 'class="form-control ck-editor" id="ckDescription2" placeholder="" autocomplete="off"');?>
                                </div>
                            </div>
                            <div class="ibox mb20">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="ibox-content">
                                            <div class="form-row">
                                                <div class="avatar " style="cursor: pointer;"><img src="<?php echo ($this->input->post('khungchuongtrinh')) ? $this->input->post('khungchuongtrinh') : ((!empty($detailjob['khungchuongtrinh'])) ? $detailjob['khungchuongtrinh'] : 'template/not-found.png'); ?>"
                                                                                                   class="js_img_result img-thumbnail" alt=""></div>
                                                <?php echo form_input('khungchuongtrinh', htmlspecialchars_decode(html_entity_decode(set_value('khungchuongtrinh', $detailjob['khungchuongtrinh']))), 'class=" form-control js_input_result" placeholder="Đường dẫn của ảnh" onclick="openKCFinder(this)"  autocomplete="off"'); ?>
                                    ...
                                    <div class="col-md-6">
                                        <div class="ibox-title">
                                            <div class="uk-flex uk-flex-middle uk-flex-space-between">
                                                <h5>Background khung chương trình</h5>

                                            </div>
                                        </div>
                                        <div class="ibox-content">
                                            <div class="form-row">
                                                <div class="avatar " style="cursor: pointer;"><img src="<?php echo ($this->input->post('khungchuongtrinh_b')) ? $this->input->post('khungchuongtrinh_b') : ((!empty($detailjob['khungchuongtrinh_b'])) ? $detailjob['khungchuongtrinh_b'] : 'template/not-found.png'); ?>"
                                                                                                   class="js_img_result img-thumbnail" alt=""></div>
                                                <?php echo form_input('khungchuongtrinh_b', htmlspecialchars_decode(html_entity_decode(set_value('khungchuongtrinh_b', $detailjob['khungchuongtrinh_b']))), 'class=" form-control js_input_result" placeholder="Đường dẫn của ảnh" onclick="openKCFinder(this)"  autocomplete="off"'); ?>
                            ...
                            <div class="ibox mb20">
                                <div class="form-group row" id="fromSlide">
                                    ...
                                    if (isset($slide) && is_array($slide) && count($slide)) {
                                        ...
                                        $albumC = json_decode($detailjob['page_1'], TRUE);
                                    }
                                    ?>
                            ...
                            <div class="row mb15">
                                <div class="col-lg-12">
                                    <div class="form-row">
                                        ...
                                        <?php echo form_input('facebook', htmlspecialchars_decode(html_entity_decode(set_value('facebook', $detailjob['facebook']))), 'class="form-control " placeholder="" autocomplete="off"');?>
                                    </div>
                                </div>
                            </div>
                            <div class="row mb15">
                                <div class="col-lg-12">
                                    <div class="form-row">
                                        ...
                                        <?php echo form_input('twitter', htmlspecialchars_decode(html_entity_decode(set_value('twitter', $detailjob['twitter']))), 'class="form-control " placeholder="" autocomplete="off"');?>
                                    </div>
                                </div>
                            </div>
                            <div class="row mb15">
                                <div class="col-lg-12">
                                    <div class="form-row">
                                        ...
                                        <?php echo form_input('instagram', htmlspecialchars_decode(html_entity_decode(set_value('instagram', $detailjob['instagram']))), 'class="form-control " placeholder="" autocomplete="off"');?>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="ibox mb20">
                                <div class="form-group row" id="fromSlide2">
                                    ...
                                    if (isset($slide_2) && is_array($slide_2) && count($slide_2)) {
                                        ...
                                        $albumC_2 = json_decode($detailjob['page_2'], TRUE);
                                    }
                                    ?>
                    ...
                    <a href="<?php echo site_url('job/backend/job/view'); ?>"
                       class="btn btn-danger block m-b pull-right" style="margin-right:10px;">Hủy bỏ</a>
                    <a target="_blank" href="<?php echo $detailjob['canonical'] ?>.html"
                       class="btn btn-primary block m-b pull-right hidden" style="margin-right:10px;">Xem trước</a>
                </div>
                <div class="col-lg-4">
                    <div class="ibox mb20">
                        <div class="ibox-title">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="block clearfix">
                                            <div class="i-checks mr30" style="width:100%;"><span
                                                        style="color:#000;"> <input <?php echo ($this->input->post('publish') == 0) ? 'checked' : (($detailjob['publish'] == 0) ? 'checked' : '') ?>  class="popup_gender_1 gender"
                                                                                                                                                                                                      type="radio"
                                                                                                                                                                                                      value="0"
                                        ...
                                        <div class="block clearfix">
                                            <div class="i-checks" style="width:100%;"><span style="color:#000;"> <input
                                                            type="radio" <?php echo ($this->input->post('publish') == 1) ? 'checked' : (($detailjob['publish'] == 1) ? 'checked' : '') ?>  class="popup_gender_0 gender"
                    ...
                    <div class="ibox mb20">
                        <div class="ibox-title">
                            <div class="uk-flex uk-flex-middle uk-flex-space-between">
                                <h5>Ảnh đại diện </h5>
                                <div class="edit">
                                    <a onclick="openKCFinderNdImage(this);return false;" href="" title=""
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-row">
                                        ...
                                        <?php echo form_input('image', htmlspecialchars_decode(html_entity_decode(set_value('image', $detailjob['image']))), 'class=" form-control js_input_result" placeholder="Đường dẫn của ảnh" onclick="openKCFinder(this)"  autocomplete="off"'); ?>
