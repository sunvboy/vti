						...
						<div class="ibox-content">
							...
							<div class="menu-list">
								...
								<div class="row mb15">
									...
									<div class="col-lg-2">
                                        <input type="text" placeholder="" name="menu[link][]" value="<?php echo $menu['link'][$key]; ?>" class="form-control postLink" >
								...
								<?php 
									$listMenu = $this->Autoload_Model->_get_where(array(
										'select' => 'id, title, link, order,module,postModule',
										'table' => 'navigation',
								...
								<div class="row mb15 menu-wrapper">
									...
									<div class="col-lg-2">
                                        <input type="text" placeholder="" value="<?php echo $val['link']; ?>" name="menu[link][]" class="form-control postLink" >
