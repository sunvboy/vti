                ...
                <div class="col-lg-4">
                    <div class="panel-head">
                        ...
                        <div class="panel-description">
                            <p>+ Danh sách menu giúp khách hàng dễ dàng xem trang web của bạn. Bạn có thể thêm menu vào
                                giao diện trong phần thiết lập giao diện</p>
                            <p>+ Bạn có thể sử dụng biểu tượng để sắp xếp thứ tự menu.</p>
                            <p>
                                + Menu còn được dùng để
                                Tạo
                                "<a href="<?php echo site_url('http://webchuanseoht.com/menu-da-cap-la-gi.html'); ?>"
                                    title="">menu xổ xuống</a>" cho trang web của bạn.
                            </p>
                            <a style="color:#000;border-color:#c4cdd5;display:inline-block !important;"
                               href="<?php echo site_url('navigation/backend/navigation/create'); ?>" title=""
                               class="btn btn-default block m-b" style="margin-right:10px;">Thêm Menu</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-8">
                    ...
                    <?php if (isset($navigationCat) && is_array($navigationCat) && count($navigationCat)) { ?>
                        <ul class="nav nav-pills">
                            <?php foreach ($navigationCat as $key => $val) { ?>
                                <li <?php if ($key == 0){ ?>class="active"<?php } ?>><a data-toggle="tab"
                                                                                        href="#menu<?php echo $val['id'] ?>"><?php echo $val['title'] ?></a>
                                </li>
                            <?php } ?>
                        </ul>
                        <div class="tab-content">
                            <?php foreach ($navigationCat as $key => $val) { ?>
                            <div id="menu<?php echo $val['id'] ?>" class="tab-pane fade <?php if ($key == 0){ ?>active in<?php } ?>">
                                <div class="ibox">
                                    <div class="ibox-title" style="padding: 9px 15px 0px;">
                                        <div class="uk-flex uk-flex-middle uk-flex-space-between">
                                            <h5><?php echo $val['title']; ?></h5>
                                            <a style="color:#000;border-color:#c4cdd5;display:inline-block !important;"
                                               href="<?php echo site_url('navigation/backend/navigation/update/' . $val['id']); ?>"
                                               title="" class="btn btn-default block m-b">Cập nhật menu</a>
                                        </div>
                                    </div>
                                    <?php if (isset($val['post']) && is_array($val['post']) && count($val['post'])) { ?>
                                        <div class="ibox-content">
                                            <div class="dd" id="nestable<?php echo $key + 2; ?>"
                                                 data-catalogueid="<?php echo $val['id']; ?>">
                                                <ol class="dd-list">
                                                    <?php foreach ($val['post'] as $keyPost => $valPost) { ?>
                                                        ...
                                                        ?>
                                                        <li class="dd-item" style="position:relative;"
                                                            data-id="<?php echo $valPost['id']; ?>">
                                                            <div class="dd-handle">
                                                                <span class="label label-info"><i class="fa fa-arrows"></i></span> <?php echo $valPost['title']; ?>
                                                            </div>
                                                            <span class="pull-right add-sub"> <a
                                                                        style="font-weight:normal;font-size:12px;"
                                                                        href="<?php echo site_url('navigation/backend/navigation/create?parentid=' . $valPost['id']) ?>"
                                                                        title="" class="">Quản lý menu con</a> </span>
                                                            <?php if (isset($_1_st_child) && is_array($_1_st_child) && count($_1_st_child)) { ?>
                                                                <ol class="dd-list">
                                                                    <?php foreach ($_1_st_child as $keyA => $valA) { ?>
                                                                        ...
                                                                        ?>
                                                                        <li class="dd-item"
                                                                            data-id="<?php echo $valA['id']; ?>">
                                                                            <div class="dd-handle">
                                                                            <span class="label label-info"><i
                                                                                        class="fa fa-arrows"></i></span> <?php echo $valA['title']; ?>
                                                                            </div>
                                                                            <span class="pull-right add-sub"> <a
                                                                                        style="font-weight:normal;font-size:12px;"
                                                                                        href="<?php echo site_url('navigation/backend/navigation/create?parentid=' . $valA['id']) ?>"
                                                                                        title=""
                                                                                        class="">Quản lý menu con</a> </span>
                                                                            <?php if (isset($_2_st_child) && is_array($_2_st_child) && count($_2_st_child)) { ?>
                                                                                <ol class="dd-list">
                                                                                    <?php foreach ($_2_st_child as $keyB => $valB) { ?>
                                                                                        ...
                                                                                        ?>
                                                                                        <li class="dd-item"
                                                                                            data-id="<?php echo $valB['id']; ?>">
                                                                                            <div class="dd-handle">
                                                                                            <span class="label label-info"><i
                                                                                                        class="fa fa-arrows"></i></span> <?php echo $valB['title']; ?>
                                                                                            </div>
                                                                                            <span class="pull-right add-sub"> <a
                                                                                                        style="font-weight:normal;font-size:12px;"
                                                                                                        href="<?php echo site_url('navigation/backend/navigation/create?parentid=' . $valB['id']) ?>"
                                                                                                        title="" class="">Quản lý menu con</a> </span>
                                                                                            <?php if (isset($_3_st_child) && is_array($_3_st_child) && count($_3_st_child)) { ?>
                                                                                                <ol class="dd-list">
                                                                                                    <?php foreach ($_3_st_child as $keyC => $valC) { ?>
                                                                                                        ...
                                                                                                        ?>
                                                                                                        <li class="dd-item"
                                                                                                            data-id="<?php echo $valC['id']; ?>">
                                                                                                            <div class="dd-handle">
                                                                                                            <span class="label label-info"><i
                                                                                                                        class="fa fa-arrows"></i></span> <?php echo $valC['title']; ?>
                                                                                                            </div>
                                                                                                            <span class="pull-right add-sub"> <a
                                                                                                                        style="font-weight:normal;font-size:12px;"
                                                                                                                        href="<?php echo site_url('navigation/backend/navigation/create?parentid=' . $valC['id']) ?>"
                                                                                                                        title=""
                                                                                                                        class="">Quản lý menu con</a> </span>
                                                                                                            <?php if (isset($_4_st_child) && is_array($_4_st_child) && count($_4_st_child)) { ?>
                                                                                                                <ol class="dd-list">
                                                                                                                    <?php foreach ($_4_st_child as $keyD => $valD) { ?>
                                                                                                                        <li class="dd-item"
                                                                                                                            data-id="<?php echo $valD['id']; ?>">
                                                                                                                            <div class="dd-handle">
                                                                                                                            <span class="label label-info"><i
                                                                                                                                        class="fa fa-arrows"></i></span> <?php echo $valD['title']; ?>
                                                                                                                            </div>
                                                                                                                            <span class="pull-right add-sub"> <a
                                                                                                                                        style="font-weight:normal;font-size:12px;"
                                                                                                                                        href="<?php echo site_url('navigation/backend/navigation/create?parentid=' . $valD['id']) ?>"
                                                                                                                                        title=""
                                                                                                                                        class="">Quản lý menu con</a> </span>
                                                                                                                        </li>
                                                                                                                    <?php } ?>
