								...
								<div class="block uk-clearfix col-lg-6">
									<div class="i-checks" style="width:100%;">
										<span style="color:#000;"> 
											<input type="radio" <?php echo ($detailCatalogue['publish'] == 0) ? 'checked' : ''	;?>  class="popup_gender_0 gender"  value="0"  name="publish">Hiển thị
										</span>
									</div>
								</div>
								<div class="block uk-clearfix col-lg-6">
									<div class="i-checks" style="width:100%;">
										<span style="color:#000;"> 
											<input type="radio" <?php echo ($detailCatalogue['publish'] == 1) ? 'checked' : '' ;?>  class="popup_gender_1 gender" required value="1" name="publish">Tắt
										</span>
									</div>
								</div>
							</div>
