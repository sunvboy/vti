						...
						<div class="ibox-content">
							<div class="row" style="margin-bottom:15px;">
								<div class="form-row col-lg-12 mb15">
                                    ...
                                    <?php echo form_input('fullname', htmlspecialchars_decode(html_entity_decode(set_value('title'))), 'class="form-control " placeholder="" autocomplete="off"');?>
								</div>
							...
							<div class="row " style="margin-bottom:15px;">
								<div class="form-row col-lg-12">
                                    ...
                                    <?php echo form_input('skype', htmlspecialchars_decode(html_entity_decode(set_value('skype'))), 'class="form-control " placeholder="" autocomplete="off"');?>
								</div>
								...
								<div class="form-row col-lg-6 hidden">
                                    ...
                                    <?php echo form_dropdown('catalogueid', dropdown(array(
                                        ...
                                        'value'=>'title',
                                        'order_by'=>'id DESC'
                                    )), set_value('catalogueid',2) ,'class="form-control input-sm perpage filter catalogueid" style="height:34px !important"'); ?>
                            ...
                            <div class="row " style="margin-bottom:15px;">
                                <div class="form-row col-lg-12">
                                    ...
                                    <?php echo form_input('order', set_value('order'), 'class="form-control " placeholder="" autocomplete="off"');?>
                                </div>
