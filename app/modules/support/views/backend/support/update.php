                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-row">
                                        ...
                                        <div class="avatar p-avatar" style="cursor: pointer;"><img
                                                    src="<?php echo ($this->input->post('image')) ? $this->input->post('image') : ((!empty($detailSupport['image'])) ? $detailSupport['image'] : 'template/avatar.png'); ?>"
                    ...
                    <div class="ibox-content">
                        <div class="row mb15">
                            ...
                            <div class="form-row col-lg-12 mb15">
                                ...
                                <?php echo form_input('fullname', htmlspecialchars_decode(html_entity_decode(set_value('fullname', $detailSupport['fullname']))), 'class="form-control " placeholder="" autocomplete="off"');?>
                        ...
                        <div class="row mb15">
                            ...
                            <div class="form-row col-lg-6">
                                <div class="uk-flex uk-flex-middle uk-flex-space-between">
                                    <label class="control-label panel-head-1">
                                        <span>Hotline<b class="text-danger">(*)</b></span>
                                    </label>
                                </div>
                                <div class="outer">
                                    <div class="uk-flex uk-flex-middle">
                        ...
                        <div class="row mb15">
                            <div class="form-row col-lg-12">
                                <label class="control-label text-left panel-head-1">
                                    <span>Điạ chỉ <b class="text-danger">(*)</b></span>
                                </label>
                                <?php echo form_input('skype', htmlspecialchars_decode(html_entity_decode(set_value('skype', $detailSupport['skype']))), 'class="form-control " placeholder="" autocomplete="off"');?>

                            </div>
                            <div class="form-row col-lg-6 hidden">
                                <label class="control-label text-left panel-head-1">
                        ...
                        <div class="row mb15">
                            <div class="form-row col-lg-12">
                                ...
                                <?php echo form_input('order', set_value('order', $detailSupport['order']), 'class="form-control " placeholder="" autocomplete="off"'); ?>
                            </div>
                                ...
                                <div class="row">
                                    <div class="block uk-clearfix col-lg-6">
										...
										<span style="color:#000;">
											<input type="radio" <?php echo ($detailSupport['publish'] == 0) ? 'checked' : ''; ?>  class="popup_gender_0 gender"
                                                   value="0" name="publish">Hiển thị
										</span>
                                        </div>
                                    </div>
                                    <div class="block uk-clearfix col-lg-6">
                                        <div class="i-checks" style="width:100%;">
										<span style="color:#000;">
											<input type="radio" <?php echo ($detailSupport['publish'] == 1) ? 'checked' : ''; ?>  class="popup_gender_1 gender"
                                                   required value="1" name="publish">Tắt
										</span>
                                        </div>
                                    </div>
                        ...
                        <div class="toolbox action clearfix">
                            <div class="uk-flex uk-flex-middle uk-button pull-right">
                                <button class="btn btn-success btn-sm" name="update" value="update" type="submit">Lưu
                                </button>
                            </div>
                        </div>
                    </div>
