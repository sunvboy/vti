        ...
        <a href="<?php echo base_url() ?>">
            <div class="llXJ_e">
                ...
                <div class="_1SY8wo _3Dl9cs">
                    <div class="_3Oyd5A">Đăng nhập</div>
                </div>
            </div>
        </a>
    </div>
        ...
        <div class="col-xs-12">
            <form action="" method="post">
                <div class="_1_eJU4">
                    ...
                    ?>
                    <div class="_3Pvd-b">
                        <?php echo form_input('email', set_value('email'), 'class="_1-SA_b _3dI7gM" placeholder="Email(Tài khoản đăng nhập)" autocomplete="off"');?>
                    </div>
                    <div class="_3Pvd-b">
                        <?php echo form_password('password', set_value('password'), 'class="_1-SA_b _3dI7gM" placeholder="Mật khẩu" autocomplete="off"');?>

                    </div>
                    <button class="_1tmt6U _32y4MW" type="submit" name="login" value="login">Đăng nhập</button>
                    <div class="_2nvW8X">
